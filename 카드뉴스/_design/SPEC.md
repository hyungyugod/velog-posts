# 지식산책 카드뉴스 스펙 — 정본 (v2, 2026-07-02 · WO-9·10 반영 2026-07-08)
...
- 구현 상태: WO-8 시드 ✅ · WO-9 레이아웃 5종+커버 ✅ · WO-10 4:5 파일럿 세트 생성 ✅(`_pilots/2026-07-08_전세금반환.html` + PNG export + 캡션 + 회고 메모). tokens 캔버스 4:5 반영 완료. **남은 판정(현규)**: 실발행 1회 + 폰 그리드 크롭·가독 확인(회고 메모 체크리스트).
